...
public class OrderIdManagerImpl implements OrderIdManager {
     ...
     * 时间格式
     */
    private static final String datePatterns = "yyMMddHHmm";
    /**
     * Long类型长度
     */
    ...
    public Long orderIdCreate() {
        ...
        //当前时间
        String dateTime = DateUtil.getCurrent(datePatterns);
        String redisSeqStr = redisSeq + "";

        //返回宝付订单号
        return Long.parseLong(dateTime +
                leftAppendZero(LONG_SIZE - dateTime.length() - redisSeqStr.length(), redisSeqStr));
    }
}
