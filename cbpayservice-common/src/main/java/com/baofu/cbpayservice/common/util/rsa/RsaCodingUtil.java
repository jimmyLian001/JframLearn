...
public final class RsaCodingUtil {
    ...
    private static Logger log = Logger.getLogger(RsaCodingUtil.class);
    ...
    public static String decryptByPubCerText(String src, String pubKeyText) {
        PublicKey publicKey = RsaReadUtil.getPublicKeyByText(pubKeyText);
        if (publicKey == null) {
            throw new BizServiceException(ErrorCodeEnum.RESULT_ERROR_BF0089);
        }
        return decryptByPublicKey(src, publicKey);
    }
     ...
     */
    public static PrivateKey readPrivateKey(String certPath, String password)
        ...
        if (file.exists()) {
            ...
            Class<? extends RsaCodingUtil> clz = RsaCodingUtil.class;
     ...
     * @throws IOException
     */
    public static PublicKey readPublicKey(String certPath)
