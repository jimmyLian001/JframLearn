...
<div class="login-layout register-layout">
    ...
    <div class="register-content">
        <from id="regPersonalFrom" action="#" method="post">
            <div class="login-title">个人用户注册</div>
            <div class="input-box">
                <i></i>
                <input type="text" placeholder="请输入手机号" name="loginNo" id="loginNo"
            ...
            <div class="verification-code-box input-box clearfix">
                ...
                <a class="fl" href="javascript:;" onclick="sendSms(this.id)" id="sendSms">获取验证</a>
    ...
    <form id="nextForm" action="${ctx}/register/personalQuestionPage.do" method="post">
