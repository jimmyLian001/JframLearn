        ...
        <div class="same-content details-content">
            ...
            <div class="clearfix">
                    ...
                    <ul class="clearfix">
                        <li class="clearfix">
                            <div class="list-left fl">
                                <p>银行所在地: </p>
                                <span>Blank Location Country</span>
                            </div>
                            <div class="list-right clearfix">
                                <span class="fl">America-美国</span>
                                <i class="country-pic fl"></i>
                            </div>
                        </li>
                        <li class="clearfix">
                            <div class="list-left fl">
                                <p>9位收款路由号码: </p>
                                <span>9-Digit Routing Number</span>
                            </div>
                        ...
                        <li class="clearfix">
                            <div class="list-left fl">
                                <p>银行账号: </p>
                                <span>Blank Account Number</span>
                            </div>
                ...
                <div class="how-to-bind fr">
                    ...
                    <a href="${ctx}/common/bindStoreExample/usd" target="_blank">点击查看账号绑定指引 > </a>
                </div>
            </div>
        </div>
        <div class="same-title">
