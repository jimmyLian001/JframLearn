...
<body>
<form id="orgAuthForm" name="orgAuthForm" method="post" action="${ctx}/auth/orgAuthEdit.do"
      enctype="multipart/form-data">
    <input type="hidden" id="multiLicenseType" name="multiLicenseType" value="${userOrgInfo.idType}"/>
    <input type="hidden" id="requestType" name="requestType" value="${requestType}"/>
    <input type="hidden" id="userInfoNo" name="userInfoNo" value="${userOrgInfo.userInfoNo}"/>
    <input type="hidden" id="idType" name="idType" value="${userOrgInfo.idType}"/>
    ...
    <div class="login-layout">
        ...
        <div class="authentication-layout register-content">
            <c:choose>
                <c:when test="${requestType ==3 || requestType ==4}">
                    <div class="authentication-title">持有人信息更新</div>
                </c:when>
                <c:otherwise>
            ...
            <div class="failure-reason ">
                <span>审核失败原因：${userOrgInfo.remarks}</span>
            </div>
                ...
                <div class="questions-info">
                    <div class="forget-item clearfix">
                        ...
                        <div class="input-box fl">
                            <input type="text" name="companyName" value="${userOrgInfo.name}" readonly="readonly">
                        </div>
                    </div>
                    <div class="forget-item clearfix">
                        <div class="item-left aut-left fl">企业英文名称</div>
                        <div class="input-box fl">
                            <input type="text" name="englishName" value="${userOrgInfo.enName}" readonly="readonly">
                        </div>
                    </div>
                    <c:if test="${realNameFlag == 0}">
                    <div class="forget-item clearfix">
                        </c:if>
                        <c:if test="${realNameFlag == 1}">
                        <div class="forget-item clearfix hide">
                            </c:if>
                            <div class="item-left aut-left fl">绑定邮箱</div>
                            <div class="input-box fl">
                                <input type="text" name="email" value="${userOrgInfo.email}" placeholder="请输入绑定邮箱">
                            </div>
                        </div>
                        <div class="forget-item clearfix">
                            <div class="item-left aut-left fl">企业证件类型</div>
                            <div class="item-right bank-btn account-btn fl">
                                <c:if test="${userOrgInfo.idType==1}">
                                    <button class="current mul-btn" type="button"
                                            onclick="changeMultiLicenseType(true)">多证合一营业执照
                                    </button>
                                    <button id="org_account_span" class="general-btn" type="button"
                                            onclick="changeMultiLicenseType(false)">普通营业执照
                                    </button>
                                </c:if>
                                <c:if test="${userOrgInfo.idType==2}">
                                    <button class="mul-btn" type="button" onclick="changeMultiLicenseType(true)">
                                        多证合一营业执照
                                    </button>
                                    <button id="org_account_span" class="general-btn current" type="button"
                                            onclick="changeMultiLicenseType(false)">普通营业执照
                                    </button>
                                </c:if>
                            </div>
                            ...
                            <div class="upload-con clearfix">
                                <div class="upload-box fl">
                                    ...
                                    <div id="image_license" class="preview">
                                        <img id="license" src="${licenseImageUrl}" width="120" height="100"/>
                                    </div>
                                </div>
                        ...
                        <div class="forget-item clearfix">
                            ...
                            <div class="input-box fl">
                                <input type="text" name="licenseNo" value="${userOrgInfo.idNo}" readonly="readonly">
                            </div>
                        </div>
                        <div class="general-display hide" id="normalLicense">
                                ...
                                <div class="upload-con clearfix">
                                    <div class="upload-box fl">
                                        ...
                                        <div id="image_taxRegCert" class="preview">
                                            <c:if test="${taxRegCertImageUrl == ''}">
                                                <img id="taxRegCert"/>
                                            </c:if>
                                            <c:if test="${taxRegCertImageUrl != ''}">
                                                <img id="taxRegCert" src="${taxRegCertImageUrl}" width="120"
                                                     height="100"/>
                                            </c:if>
                                        </div>
                                    </div>
                                ...
                                <div class="upload-con clearfix">
                                    <div class="upload-box fl">
                                        ...
                                        <div id="image_orgCodeCert" class="preview">
                                            <c:if test="${orgCodeCertImageUrl == ''}">
                                                <img id="orgCodeCert"/>
                                            </c:if>
                                            <c:if test="${orgCodeCertImageUrl != ''}">
                                                <img id="orgCodeCert" src="${orgCodeCertImageUrl}" width="120"
                                                     height="100"/>
                                            </c:if>
                                        </div>
                                    </div>
                        ...
                        <div class="forget-item clearfix">
                            ...
                            <div class="input-box fl">
                                <input type="text" id="legalName" name="legalName" value="${userOrgInfo.legalName}"
                                       readonly="readonly">
                        ...
                        <div class="forget-item clearfix">
                            ...
                            <div class="input-box fl">
                                <input type="text" id="legalNo" name="legalNo" value="${userOrgInfo.legalIdNo}"
                                       readonly="readonly">
                                <div class="input-tip" style="display: none;">
                                    <em class="fl"></em>
                                    <span>以上内容不能为空/输入格式不正确</span>
                        ...
                        <div class="forget-item clearfix">
                            ...
                            <div class="input-box fl">
                                <input type="text" id="postCode" name="postCode" value="${userOrgInfo.postCode}"
                                       placeholder="请输入邮编">
                                <div class="input-tip" style="display: none;">
                                    <em class="fl"></em>
                                    <span>以上内容不能为空/输入格式不正确</span>
                        ...
                        <div class="forget-item clearfix">
                            ...
                            <div class="input-box fl">
                                <select id="province" name="province" class="select-box small-select"
                                        onchange="initCity(null)">
                                    <option value="${userOrgInfo.province}" class="select-default"></option>
                                </select>
                                <select id="city" name="city" class="select-box small-select" onchange="initArea(null)">
                                    <option value="${userOrgInfo.city}" class="select-default"></option>
                                </select>
                                <select id="area" name="area" class="select-box small-select last-select">
                                    <option value="${userOrgInfo.area}" class="select-default"></option>
                                </select>
                                <div class="input-tip" style="display:none;">
                                    <em class="fl"></em>
                                    <span>请选择所在地址</span>
                        ...
                        <div class="forget-item clearfix">
                            ...
                            <div class="textarea-box fl">
                                <textarea id="address" name="address"
                                          placeholder="请输入详细地址，如***路***号">${userOrgInfo.address}</textarea>
                            </div>
                        </div>
        ...
        <script src="${ctx}/business/auth/verify/orgAuthEditVerify.js?version=${version}"></script>
</body>
</html>