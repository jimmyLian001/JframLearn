    ...
    <div class="same-layout">
        ...
        <div class="same-middle setting-middle">
            <ul class="clearfix">
                ...
                <li class="clearfix enterprise-name">
                    <div class="user-info-left fl">企业名称</div>
                    <div class="user-info-right">
                        <span>${userInfo.orgName}</span>
                    </div>
                </li>
                <li class="clearfix">
                    <div class="user-info-left fl">法人姓名</div>
                    <div class="user-info-right">
                        <span>${userInfo.name}</span>
                    </div>
                </li>
                <li class="clearfix">
                    <div class="user-info-left fl">法人证件号</div>
                    <div class="user-info-right">
                        <span>
            ...
            <c:if test="${securityConfigVo.authStatus==3}">
                <div class="btn-box login-btn">
                    <a href="${ctx}/auth/1/orgAuthEditPage.do?userInfoNo=${userInfo.userInfoNo}">补充实名信息</a>
                </div>
            </c:if>
        </div>
        <div class="same-content setting-content">
            ...
            <div class="clearfix setting-type">
                <div class="security-setting-left fl">
                    ...
                    <div class="setting-suggest fl">密保问题可以帮助你修改支付密码和修改绑定手机</div>
                </div>
                <div class="security-setting-right fr">
                    <ul class="clearfix">
