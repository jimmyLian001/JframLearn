...
<div class="login-layout">
    ...
    <div class="same-layout small" id="paymentPwdIndex">
        ...
        <div class="same-content">
            <form action="${ctx}/person/center/createPayPwd.do" id="pay_pwd_form" method="post">
                ...
                <div class="same-item clearfix">
                    ...
                    <div class="item-right fl">
                        <span>${f:secrueqaEncrypt(loginNo)}</span></div>
                </div>
                <div class="same-item clearfix">
                ...
                <div class="same-item clearfix">
                    <div class="item-left fl">支付密码 <i style="color:red">*</i></div>
                    <div class="input-box fl">
                        <input type="password" id="payPwd" name="payPwd" maxlength="6" placeholder="请输入支付密码">
                        <div class="input-tip">
                            <s>支付密码由6位数字组成</s>
                        </div>
                    </div>
                ...
                <div class="same-item clearfix">
                    ...
                    <div class="input-box fl">
                        <input type="password" id="payPwdAgain" name="payPwdAgain" maxlength="6" placeholder="请输入重复密码">
                    </div>
                </div>
                <div class="btn-box item-btn">
                    <button type="submit" id="pay_pwd_Sub">下一步</button>
                    <button class="cancel-btn" type="button"
                            onclick="window.location='${ctx}/person/center/index.do'">返回
                    </button>
                </div>
            </form>
        </div>
