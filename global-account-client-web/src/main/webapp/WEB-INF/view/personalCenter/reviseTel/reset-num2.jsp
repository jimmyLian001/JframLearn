        ...
        <form action=" ${ctx}/userTel/bindPhoneNoApply.do" method="post" id="form-tel">
            <div class="same-content">
                ...
                <div class="same-item clearfix">
                    <input type="hidden" id="serviceType" name="serviceType" value="updateTel">
                    <div class="item-left fl">新手机号 <i style="color:red">*</i></div>
                    <div class="input-box fl">
                        <input type="text" placeholder="请输入新手机号" id="afterFixPhoneNumber" maxlength="11"
                               name="afterFixPhoneNumber">
                    </div>
                </div>
                <div class="same-item clearfix">
                ...
                <div class="btn-box item-btn">
                    ...
                    <button class="cancel-btn" type="button" onclick="javascript:history.go(-1)">
                        返回
                    </button>
                </div>
